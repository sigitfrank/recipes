...
function AddRecipes() {
    ...
    return (
        <>
            ...
            <form className="add-recipes" onSubmit={handleFormSubmit}>
                {/* Header */}
                            ...
                            <section className="row">
                                ...
                                <div className="row">
                                    <div className="col-md-4">
                                        ...
                                        {mainImage.error.status && <InvalidFeedback message={mainImage.error.message} isError={mainImage.error.status} />}
